...
// ─────────────────────────────────────
class _TaskBubble extends StatefulWidget {
  final Message message;
  final String Function(DateTime) formatTime;
  ...
  @override
  State<_TaskBubble> createState() => _TaskBubbleState();
}

class _TaskBubbleState extends State<_TaskBubble> {
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Title (first line of message.text before \n\n)
                  Text(
                    message.text.split('\n\n').first,
                    style: TextStyle(
                      fontSize: 14,
                  ...
                  // Description (rest of message.text)
