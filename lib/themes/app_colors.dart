...
class AppColors {
  ...
  // Light Mode Primary
  static const Color lightPrimary = Color(0xFF228B22);       // Green Forest
  ...
  static const Color darkOnPrimary = Color(0xFF690003);      // Dark text on light primary

  // --- SECONDARY COLORS ---

  // Light Mode Secondary
  static const Color lightSecondary = Color(0xFF8FBC8F);     // Soft Sage
  static const Color lightOnSecondary = Color(0xFFFFFFFF);   // White text on secondary

  // Dark Mode Secondary
  static const Color darkSecondary = Color(0xFF90CAF9);      // Light blue
  static const Color darkOnSecondary = Color(0xFF002244);    // Dark text on light secondary

  // --- TERTIARY/ACCENT COLORS ---

  static const Color lightTertiary = Color(0xFFF5F5DC);      // Warm Beige (Light mode)
  static const Color darkTertiary = Color(0xFFFFD54F);      // Brighter gold (Dark mode)

  // --- SURFACE COLORS ---

  static const Color lightSurface = Color(0xFFFAFAFA);      // Light background
  static const Color lightSurfaceContainer = Color(0xFFFFFFFF); // Card background

  static const Color darkSurface = Color(0xFF121212);        // Dark background
  static const Color darkSurfaceContainer = Color(0xFF1E1E1E); // Card background
  ...
  static const Color lightTextSecondary = Color(0xFF555555); // Secondary text (Light)
  static const Color lightTextTertiary = Color(0xFF777777);  // Tertiary text (Light)

  static const Color darkTextPrimary = Color(0xFFE0E0E0);    // Main text (Dark)
  static const Color darkTextSecondary = Color(0xFFBBBBBB);  // Secondary text (Dark)
  static const Color darkTextTertiary = Color(0xFF999999);   // Tertiary text (Dark)
